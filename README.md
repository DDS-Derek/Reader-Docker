...
### 方法2. 使用 user + command 实现 (Umask 无法设置)

**docker-cli**

```bash
mkdir -p $(pwd)/logs $(pwd)/storage
chown -R 1000:1000 $(pwd)/logs $(pwd)/storage
...
chown -R 1000:1000 /home/reader/logs /home/reader/storage
```
```yaml
version: '3.1'
services:
